...
# These options are unique to this command 
...
curl -G -o sploit_output.txt --ignore-content-length --silent --verbose --cookie "LAB_GROUP_SECRET_KEY=${LAB_GROUP_SECRET_KEY}" -- http://127.0.0.1:${GROUP_PORT_NO}/index.html
